...
public class UserController {
	...
	Member m = new Member();
	static ArrayList<Member> user = new ArrayList<Member>();// 유저정보 담들것
...
//				System.out.println(user.get(i).getUserId() + " " + user.get(i).getUserPwd() + " "
//						+ user.get(i).getName() + " " + user.get(i).getAge() + " " + user.get(i).getGender() + " "
//						+ user.get(i).getEmail() + " " + user.get(i).getPoint());
//
//			} else {
